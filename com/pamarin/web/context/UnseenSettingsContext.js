 ...
 * create 21/03/2014
 */
define('com.pamarin.web.context.UnseenSettingsContext', [
    'module',
...
], function(module, Class, Assert, Types, Urls, Router, StringUtils, ArrayList, Singleton, IllegalStateException, LoggerFactory, PageContext, Unseen, Gps, UnseenTab, UnseenCtx) {

    /**
     * @class UnseenSettingsContext
     */
    var UnseenSettingsContext = Class.define(module.id, (function() {
        ...
        function createUnseen(unseenId) {
            var usn = window.pamarin.unseen;

            var unseen = new Unseen();
            unseen.setUnseenId(unseenId);
            unseen.setUnseenName(usn.unseenName);
            unseen.setGps(new Gps(usn.gps.latitude, usn.gps.longitude));

            context.setUnseen(unseen);
        }

        function createTab(unseenId) {
            var tab = new UnseenTab();
        ...
        return {
            ...
            static: {
                /**
                 * @returns {UnseenSettingsContext}
                 */
                getInstance: function() {
                    return Singleton.getInstance(UnseenSettingsContext);
                }
            }
        };
    })());
