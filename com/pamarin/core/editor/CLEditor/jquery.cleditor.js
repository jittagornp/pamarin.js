 ...
 */
        ...
        (function($) {
            ...
            $.cleditor = {
                ...
                defaultOptions: {
                    ...
                    colors: // colors in the color popup
                            "3297fd 0078da 333 555 777 999 aaa ccc ddd eee",
                    ...
                    bodyStyle: // style to assign to document body contained within the editor
                            "padding : 5px; word-wrap : break-word; margin:4px; font:10pt Arial,Verdana; cursor:text"
                },
            ...
            $.fn.cleditor = function(options) {
                ...
                parent.addClass('cleditorParent');
                parent.attr('tabindex', -1).prepend($('<div>').addClass('cleditor-prepend-toolbar'));

                parent.find('iframe').contents().find('*').click(function(){
                    $('.cleditorToolbar').hide();
                    parent.find('.cleditorToolbar').show();
                });
                
                var closeButton = $('<div>').addClass('cleditor-toolbar-close').click(function(){
                    $(this).parent().hide();
                }).attr('title', 'close');
                
                var tail = $('<div>').addClass('cleditor-toolbar-tail');
                
                parent.find('.cleditorToolbar').width(parent.width() - 12).append(closeButton).append(tail);
            ...
            function createPopup(popupName, options, popupTypeClass, popupContent, popupHover) {
                ...
                // Size
                    ...
                    for (var index in options.sizes) {
                        $(DIV_TAG).appendTo($popup)
                                .html('<font size="' + index + '">' + options.sizes[index] + '</font>');
                    }
            ...
            function refresh(editor) {
                ...
                $(function() {
                    ...
                    $frame.width(wid).height(hgt + 11);

                    // Resize the textarea. IE6 textareas have a 1px top
                    // & bottom margin that cannot be removed using css.
                    var areaHeight = ie6 ? hgt - 2 : hgt;
                    areaHeight += 11;
                    editor.$area.width(wid).height(areaHeight);
